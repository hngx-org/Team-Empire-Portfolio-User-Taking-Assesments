...
# a class that takes in a list of permissions and
# checks if a permission is present in the list
class Permissions:
    """
    Permissions class

    This class is used to check if a permission is
    present in the list of permissions.

    It has the following attributes:
    - permissions: This is the list of permissions

    It has the following methods:
    - check_permission: This method checks if a permission
    is present in the list of permissions
    ...
    def check_permission(self, permissions: list, permission: str):
        ...
        Returns:
        - bool: This is True if the permission is present in the
        list of permissions else False
    ...
    def check_permissions(self, permissions: list):
        ...
        Returns:
        - bool: This is True if the list of permissions is present in the
                list of permissions else False
